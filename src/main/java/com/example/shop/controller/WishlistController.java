...
public class WishlistController {
    ...
    @GetMapping("/check")
    public Map<String, Boolean> check(@RequestParam Long userId, @RequestParam Long productId) {
        return Map.of("wishlisted", wishlistService.isWishlisted(userId, productId));
    }

    @GetMapping("/count")
    public Map<String, Integer> getCount(@RequestParam Long userId) {
    ...
    @DeleteMapping
    public Map<String, String> remove(@RequestParam Long userId, @RequestParam Long productId) {

...
public class SupportAdminSessionPageResponse {
    ...
    public static SupportAdminSessionPageResponse of(List<SupportSession> items, long total, int page, int size) {
        SupportAdminSessionPageResponse response = new SupportAdminSessionPageResponse();

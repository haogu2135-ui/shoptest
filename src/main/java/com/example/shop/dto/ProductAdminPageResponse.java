...
public class ProductAdminPageResponse {
    ...
    public static ProductAdminPageResponse of(List<Product> items, long total, int page, int size) {
        ProductAdminPageResponse response = new ProductAdminPageResponse();

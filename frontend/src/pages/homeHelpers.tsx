...
export const buildHomeMobileQuickActionDescriptors = (params: {
  ...
  {
    key: 'orders',
    label: params.t('home.quick.orders'),
    iconKey: 'file',
    intent: 'orders',
  },
  {
    key: 'cart',
    label: params.t('home.quick.cart'),
    iconKey: 'cart',
    intent: 'cart',
  },
  {
    key: 'coupons',
    label: params.t('home.quick.coupons'),
    iconKey: 'gift',
    intent: 'coupons',
  },
  {
    key: 'seckill',
    label: params.t('home.quick.flashDeals'),
    iconKey: 'thunder',
    intent: 'seckill',
  },
  {
    key: 'wishlist',
    label: params.t('home.quick.favorites'),
    iconKey: 'heart',
    intent: 'wishlist',
  },
  {
    key: 'track',
    label: params.t('home.quick.track'),
    iconKey: 'truck',
    intent: 'track',
  },
  {
    key: 'support',
    label: params.t('home.quick.support'),
    iconKey: 'support',
    intent: 'support',
  },
  {
    key: 'finder',
    label: params.t('home.quick.finder'),
    iconKey: 'compass',
    intent: 'finder',
  },
  {
    key: 'history',
    label: params.t('home.quick.history'),
    iconKey: 'history',
    intent: 'history',
  },
];
